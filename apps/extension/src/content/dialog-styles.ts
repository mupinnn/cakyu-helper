...
.field { display: flex; flex-direction: column; gap: 4px; font-size: 12px; color: #4a5568; margin-bottom: 10px; min-width: 0; }
...
.grid { display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 0 12px; }
